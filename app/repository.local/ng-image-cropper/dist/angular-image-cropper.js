...
/***/ function(module, exports) {
	...
	Cropper.prototype.buildDOM = function() {
	  ...
	  _elements.controls.rotateLeft = document.createElement('button');
		...
		_elements.controls.rotateLeft.className = 'btn btn-xs btn-primary';
	  _elements.controls.rotateLeft.setAttribute("type", "button");
	  ...
	  _elements.controls.rotateRight.innerHTML = this.options.actionLabels.rotateRight;
		_elements.controls.rotateRight.className = 'btn btn-xs btn-primary';
		_elements.controls.rotateRight.setAttribute("type", "button");
	  ...
	  _elements.controls.zoomIn.innerHTML = this.options.actionLabels.zoomIn;
		_elements.controls.zoomIn.className = 'btn btn-xs btn-primary';
		_elements.controls.zoomIn.setAttribute("type", "button");
	  ...
	  _elements.controls.zoomOut.innerHTML = this.options.actionLabels.zoomOut;
		_elements.controls.zoomOut.className = 'btn btn-xs btn-primary';
		_elements.controls.zoomOut.setAttribute("type", "button");
	  _elements.controls.fit = document.createElement('button');
	  _elements.controls.fit.innerHTML = this.options.actionLabels.fit;
		_elements.controls.fit.className = 'btn btn-xs btn-primary';
		_elements.controls.fit.setAttribute("type", "button");

	  _elements.controls.crop = document.createElement('button');
	  _elements.controls.crop.innerHTML = this.options.actionLabels.crop;
		_elements.controls.crop.className = 'btn btn-xs btn-primary';
		_elements.controls.crop.setAttribute("type", "button");
