...
define([], function () {
  ...
  function DesignsController($scope, $stateParams, $state, $modal, $aside, $q, $http, Identify3D, ordersData){
    ...
    console.log("prayers:", ordersData);
  ...
  return {'DesignsController': ['$scope', '$stateParams', '$state', '$modal', '$aside', '$q', '$http', 'Identify3DObject', 'ordersData', DesignsController]};
});
